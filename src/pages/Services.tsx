      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          {services.map((service, index) => (
            <div
              key={index}
              className="p-6 border border-gray-800 rounded-lg hover:border-brown-400 transition-all duration-300 transform hover:-translate-y-1"
            >
              <service.icon className="w-12 h-12 text-brown-400 mb-4" />
        ...
        <section className="mb-16">
          ...
          <div className="space-y-6">
            <div className="p-6 bg-brown-400 rounded-lg">
              <h3 className="text-xl font-bold mb-4">Présentations Interactives</h3>
            ...
            <div className="p-6 bg-brown-400 rounded-lg">
              <h3 className="text-xl font-bold mb-4">Contenu Personnalisé</h3>
              <p className="text-white">
