...
export function Home() {
  return (
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-20">
          <div className="text-center">
            <div className="inline-block relative">
              <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-fade-in bg-clip-text text-transparent bg-gradient-to-r from-brown-400 via-brown-300 to-brown-400">
                Guardia Recon Unit
              </h1>
              <div className="absolute -inset-1 blur-2xl bg-brown-400/20 rounded-full opacity-75"></div>
            </div>
      ...
      <section className="py-16 bg-black/90">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-6 border border-gray-800 rounded-lg hover:border-brown-400 transition-colors duration-300">
              <Shield className="w-12 h-12 text-brown-400 mb-4" />
            ...
            <div className="p-6 border border-gray-800 rounded-lg hover:border-brown-400 transition-colors duration-300">
              <Eye className="w-12 h-12 text-brown-400 mb-4" />
            ...
            <div className="p-6 border border-gray-800 rounded-lg hover:border-brown-400 transition-colors duration-300">
              <Users className="w-12 h-12 text-brown-400 mb-4" />
      ...
      <section className="py-16 bg-gradient-to-b from-black to-brown-400/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
